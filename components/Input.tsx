...
function Input(props: any) {
  ...
  return (
    <div
      ...
      } dark:text-white rounded-lg bg-gray-400/10 dark:bg-gray-500/5 dark:hover:bg-gray-500/10 hover:bg-gray-400/20 outline-none border-2 border-white/0 block w-full transition-all duration-200 ease-in-out sm:text-sm sm:leading-5 ${
        focused && "bg-gray-400/20 border-primary/100"
      } ${className}`}
    >
      {startsWith && (
        <div
