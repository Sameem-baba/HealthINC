  ...
  return (
    <div>
      <div className="items-center hidden md:flex space-x-2">
        <button className="px-4 py-2 rounded-xl flex items-center justify-center uppercase  tracking-widest bg-[#587ce0] transition-all duration-200 ease-in">
          Donate
        </button>
        ...
        <SocialIcon
          ...
          fgColor={hoveredIcon == "facebook" ? "#102eaa" : "gray"}
          bgColor="transparent"
        />
        <SocialIcon
          ...
          fgColor={hoveredIcon == "instagram" ? "#102eaa" : "gray"}
          bgColor="transparent"
        />
        <SocialIcon
          ...
          onMouseLeave={() => setHoveredIcon("")} // this needs to be done or else the icon would stay purple
          fgColor={hoveredIcon == "twitter" ? "#102eaa" : "gray"}
          bgColor="transparent"
        />
      </div>
    </div>
